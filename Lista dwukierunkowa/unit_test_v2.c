 ...
 * Test wygenerowano automatycznie o 2022-06-02 18:01:31.832649
 *
 * Debug: 
 */
...
void UTEST7(void)
{
    ...
    //
            ...
            int tab[] = {2, -4, 6, 9, 3, 4, 1, -2};
            int rtab[] = {-2, 1, 4, 3, 9, 6, -4, 2};
...
//
//  Test 9: Sprawdzanie poprawności działania funkcji push_front (limit sterty ustawiono na 208 bajtów)
//
void UTEST9(void)
{
    // informacje o teście
    test_start(9, "Sprawdzanie poprawności działania funkcji push_front (limit sterty ustawiono na 208 bajtów)", __LINE__);
...
void UTEST14(void)
{
    ...
    //
            ...
            int tab[] = {-7, 5, 10, 9, -6, 1, -6};
            int rtab[] = {-6, 1, -6, 9, 10, 5, -7};
...
void UTEST16(void)
{
    ...
    //
            ...
            int tab[] = {-10, 1, -10, 4, -2, -8, 9};
            int rtab[] = {9, -8, -2, 4, -10, 1, -10};
...
void UTEST18(void)
{
    ...
    //
            ...
            int tab[] = {10, -9, 10, 9, 8, 9, 5, 1};
            int rtab[] = {1, 5, 9, 8, 9, 10, -9, 10};
...
void UTEST20(void)
{
    ...
    //
            ...
            for (int i = 0; i < 7 - 1; ++i)
            {
                ...
                dll_pop_back(dll, &err_code);
                err_code = dll_size(dll);
                test_error(err_code == 7 - i - 1, "Funkcja dll_size() powinna zwrócić %d, a zwróciła %d", 7 - i - 1, err_code);
            }
...
void UTEST24(void)
{
    ...
    //
                ...
                int tab[] = {6, 2, -8, -5, -6};
                int expected_tab[] = {1, 6, 2, -8, -5, -6};
                int rtab[] = {-6, -5, -8, 2, 6, 1};
...
void UTEST25(void)
{
    ...
    //
                ...
                int tab[] = {6, 2, -8, -5, -6};
                int expected_tab[] = {6, 2, -8, -5, -6, -8};
                int rtab[] = {-8, -6, -5, -8, 2, 6};
...
void UTEST26(void)
{
    ...
    //
                ...
                int tab[] = {6, 2, -8, -5, -6};
                int expected_tab[] = {6, 2, 1, -8, -5, -6};
                int rtab[] = {-6, -5, -8, 1, 2, 6};
...
//
//  Test 27: Sprawdzanie poprawności działania funkcji insert (limit sterty ustawiono na 136 bajtów)
//
void UTEST27(void)
{
    // informacje o teście
    test_start(27, "Sprawdzanie poprawności działania funkcji insert (limit sterty ustawiono na 136 bajtów)", __LINE__);
...
//
//  Test 28: Sprawdzanie poprawności działania funkcji insert (limit sterty ustawiono na 136 bajtów)
//
void UTEST28(void)
{
    // informacje o teście
    test_start(28, "Sprawdzanie poprawności działania funkcji insert (limit sterty ustawiono na 136 bajtów)", __LINE__);
...
//
//  Test 29: Sprawdzanie poprawności działania funkcji insert (limit sterty ustawiono na 136 bajtów)
//
void UTEST29(void)
{
    // informacje o teście
    test_start(29, "Sprawdzanie poprawności działania funkcji insert (limit sterty ustawiono na 136 bajtów)", __LINE__);
...
void UTEST31(void)
{
    ...
    //
                ...
                int expected_tab[] = {2, 1, 8, -7, 4, -6, -2};
                int tab[] = {-4, 2, 1, 8, -7, 4, -6, -2};
                int rtab[] = {-2, -6, 4, -7, 8, 1, 2};
...
void UTEST32(void)
{
    ...
    //
                ...
                err_code = 1;
                int value = dll_remove(dll, 7, &err_code);
                test_error(err_code == 0, "Funkcja dll_remove() powinna zwrócić kod błędu 0, a zwróciła %d", err_code);
                test_error(value == 10, "Funkcja dll_remove() powinna zwrócić wartość 10, a zwróciła %d", err_code);
...
void UTEST33(void)
{
    ...
    //
                ...
                err_code = 1;
                int value = dll_remove(dll, 3, &err_code);
                test_error(err_code == 0, "Funkcja dll_remove() powinna zwrócić kod błędu 0, a zwróciła %d", err_code);
                test_error(value == 10, "Funkcja dll_remove() powinna zwrócić wartość 10, a zwróciła %d", err_code);
...
void UTEST35(void)
{
    ...
    //
                ...
                int value = dll_remove(dll, 7, NULL);
                test_error(value == 10, "Funkcja dll_remove() powinna zwrócić wartość 10, a zwróciła %d", err_code);
...
void UTEST36(void)
{
    ...
    //
                ...
                int value = dll_remove(dll, 3, NULL);
                test_error(value == 10, "Funkcja dll_remove() powinna zwrócić wartość 10, a zwróciła %d", err_code);
...
void UTEST37(void)
{
    ...
    //
            ...
            dll_remove(dll, -7, NULL);
            dll_remove(dll, 8, NULL);
...
//
//  Test 3: Reakcja na brak pamięci (limit sterty ustawiono na 112 bajtów)
//
void MTEST3(int argc, char** argv, char** envp)
{
    // informacje o teście
    test_start(3, "Reakcja na brak pamięci (limit sterty ustawiono na 112 bajtów)", __LINE__);
...
//
//  Test 4: Reakcja na brak pamięci (limit sterty ustawiono na 112 bajtów)
//
void MTEST4(int argc, char** argv, char** envp)
{
    // informacje o teście
    test_start(4, "Reakcja na brak pamięci (limit sterty ustawiono na 112 bajtów)", __LINE__);
...
//
//  Test 5: Reakcja na brak pamięci (limit sterty ustawiono na 112 bajtów)
//
void MTEST5(int argc, char** argv, char** envp)
{
    // informacje o teście
    test_start(5, "Reakcja na brak pamięci (limit sterty ustawiono na 112 bajtów)", __LINE__);
...
int __wrap_main(volatile int _argc, char** _argv, char** _envp)
{
    ...
    if (run_mode == rm_unit_test)
    {
        ...
        { 
            ...
            UTEST9, // Sprawdzanie poprawności działania funkcji push_front (limit sterty ustawiono na 208 bajtów)
            ...
            UTEST27, // Sprawdzanie poprawności działania funkcji insert (limit sterty ustawiono na 136 bajtów)
            UTEST28, // Sprawdzanie poprawności działania funkcji insert (limit sterty ustawiono na 136 bajtów)
            UTEST29, // Sprawdzanie poprawności działania funkcji insert (limit sterty ustawiono na 136 bajtów)
    ...
    if (run_mode == rm_main_test)
    {
        ...
        { 
            ...
            MTEST3, // Reakcja na brak pamięci (limit sterty ustawiono na 112 bajtów)
            MTEST4, // Reakcja na brak pamięci (limit sterty ustawiono na 112 bajtów)
            MTEST5, // Reakcja na brak pamięci (limit sterty ustawiono na 112 bajtów)
            NULL
        };
